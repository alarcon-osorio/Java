...
public class ProblemOneJavaYa {
    ...
    public void titulo() {
        System.out.println("Las listas genericas deciden la posicion de los elementos"
                + " si la posicion esta repetida imprime siempre el ultimo insertado ");
        System.out.println("Listado de elementos insertados en la pila");
    }
    ...
    public static void main(String[] ar) {
        ProblemOneJavaYa lg=new ProblemOneJavaYa();
        lg.titulo();
        lg.insertar (1, 10);
        lg.insertar (2, 20);
        lg.insertar (3, 30);
